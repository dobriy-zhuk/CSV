...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CSV_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 15, 4),
QT_MOC_LITERAL(5, 20, 4)
    },
    "CSV\0open\0\0save\0find\0quit\0"
};
...
const QMetaObject CSV::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CSV.data,
      qt_meta_data_CSV,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CSV.stringdata))
        return static_cast<void*>(const_cast< CSV*>(this));
