...
# Project:  CSV.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile CSV.pro
#############################################################################
...
Makefile: CSV.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CSV1.0.0/ && $(COPY_FILE) --parents csv.h .tmp/CSV1.0.0/ && $(COPY_FILE) --parents main.cpp csv.cpp .tmp/CSV1.0.0/ && (cd `dirname .tmp/CSV1.0.0` && $(TAR) CSV1.0.0.tar CSV1.0.0 && $(COMPRESS) CSV1.0.0.tar) && $(MOVE) `dirname .tmp/CSV1.0.0`/CSV1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CSV1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_csv.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_csv.cpp
moc_csv.cpp: /usr/include/qt5/QtWidgets/QWidget \
...
moc_csv.o: moc_csv.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_csv.o moc_csv.cpp
